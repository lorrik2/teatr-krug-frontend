...
export interface Performance {
  ...
  isPremiere?: boolean;
  /**
   * В афише: спектакль в разделе «Афиша», на главной в блоке афиши и в выдаче /afisha.
   * Если false — только «Репертуар»; даты и покупка билета на странице не показываются.
   */
  inAfisha?: boolean;
  /**
   * Показывать блок с датами/расписанием и кнопки покупки билета (слайдер, карточки).
   * По умолчанию true; учитывается только вместе с inAfisha.
   */
  showScheduleAndTickets?: boolean;
