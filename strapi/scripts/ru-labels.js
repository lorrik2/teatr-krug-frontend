...
const CONTENT_TYPE_LABELS = {
  ...
  'api::dostupnaya-sreda.dostupnaya-sreda': {
    ...
    generalHeading: 'Блок 1: заголовок',
    generalText: 'Блок 1: текст',
    buildingHeading: 'Блок 2: заголовок',
    buildingText: 'Блок 2: текст',
    servicesHeading: 'Блок 3: заголовок',
    servicesText: 'Блок 3: текст',
    staffHeading: 'Блок 4: заголовок',
    staffText: 'Блок 4: текст',
    contactHeading: 'Блок 5: заголовок',
    contactText: 'Блок 5: текст (до ссылки на Контакты)',
    showContactsLink: 'Ссылка на страницу «Контакты»',
  },
  'api::contact.contact': {
    address: 'Адрес',
    boxOffice: 'Касса',
  ...
  'api::performance.performance': {
    ...
    isPremiere: 'Премьера',
    inAfisha: 'В афише',
    showScheduleAndTickets: 'Даты и покупка билета на странице',
    schedule: 'Расписание',
    awards: 'Награды',
    festivals: 'Фестивали',
